...
A1A1_data_url = "http://th-www.if.uj.edu.pl/~erichter/forHiggsCP/HiggsCP_data/a1a1/"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", dest="IN", help="URL for data files folder", default=A1A1_data_url)
