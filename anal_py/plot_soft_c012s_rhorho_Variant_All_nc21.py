...
pathIN  = "../laptop_results/nn_rhorho_Variant-All_soft_c012s_hits_c0s_Unweighted_False_NO_NUM_CLASSES_21/monit_npy/"
calc_hits_c0s   = np.load(pathIN+'train_soft_calc_hits_c012s.npy')
preds_hits_c0s  = np.load(pathIN+'train_soft_preds_hits_c012s.npy')

pathIN  = "../laptop_results/nn_rhorho_Variant-All_soft_c012s_hits_c1s_Unweighted_False_NO_NUM_CLASSES_21/monit_npy/"
calc_hits_c1s   = np.load(pathIN+'train_soft_calc_hits_c012s.npy')
preds_hits_c1s  = np.load(pathIN+'train_soft_preds_hits_c012s.npy')

pathIN  = "../laptop_results/nn_rhorho_Variant-All_soft_c012s_hits_c2s_Unweighted_False_NO_NUM_CLASSES_21/monit_npy/"
...
delt_c0s =  calculate_deltas_signed(np.argmax(preds_hits_c0s[:], axis=1), np.argmax(calc_hits_c0s[:], axis=1), 21)      
delt_c1s =  calculate_deltas_signed(np.argmax(preds_hits_c1s[:], axis=1), np.argmax(calc_hits_c1s[:], axis=1), 21)      
delt_c2s =  calculate_deltas_signed(np.argmax(preds_hits_c2s[:], axis=1), np.argmax(calc_hits_c2s[:], axis=1), 21)      

#----------------------------------------------------------------------------------
filename = "soft_calc_c0s_rhorho_Variant-All_nc21"

plt.hist(calc_c0s, histtype='step', bins=20,  color = 'black', label = "generated")
plt.hist(preds_c0s, histtype='step', bins=20,  color = 'red', label = "predicted")
plt.xlim([0, 20.0])
plt.ylim([0, 15000])
...
#----------------------------------------------------------------------------------
filename = "delt_soft_c0s_rhorho_Variant-All_nc21"
...
#----------------------------------------------------------------------------------
filename = "soft_calc_c1s_rhorho_Variant-All_nc21"

plt.hist(calc_c1s, histtype='step', bins=20,  color = 'black', label = "generated")
plt.hist(preds_c1s, histtype='step', bins=20,  color = 'red', label = "predicted")
plt.xlim([0, 20.0])
plt.ylim([0, 15000])
plt.xlabel(r'Class index')
plt.title('Features list: Variant-All')
...
#----------------------------------------------------------------------------------
filename = "delt_soft_c1s_rhorho_Variant-All_nc21"
...
#----------------------------------------------------------------------------------
filename = "soft_calc_c2s_rhorho_Variant-All_nc21"

plt.hist(calc_c2s, histtype='step', bins=20,  color = 'black', label = "generated")
plt.hist(preds_c2s, histtype='step', bins=20,  color = 'red', label = "predicted")
plt.xlim([0, 20.0])
plt.ylim([0, 15000])
plt.xlabel(r'Class index')
plt.title('Features list: Variant-All')
...
#----------------------------------------------------------------------------------
filename = "delt_soft_c2s_rhorho_Variant-All_nc21"
