...
file_Variant_1 =   'npy/nn_rhorho_Variant-1.1_Unweighted_False_NO_NUM_CLASSES_3/monit_npy/'
file_Variant_4 =   'npy/nn_rhorho_Variant-4.1_Unweighted_False_NO_NUM_CLASSES_3/monit_npy/'
file_Variant_All = 'npy/nn_rhorho_Variant-All_Unweighted_False_NO_NUM_CLASSES_3/monit_npy/'
...
pathOUT  = "figures/"
filename = "rhorho_roc_auc_w_nc_3"
...
plt.ylabel('ROC AUC vs class index = 1')
plt.title('Class index: = 1, 3 (scalar), =2 (pseudoscalar)')
