...
file_Variant_1 = 'npy/nn_a1rho_Variant-1.1_Unweighted_False_NO_NUM_CLASSES_20'
file_Variant_4 = 'npy/nn_a1rho_Variant-4.1_Unweighted_False_NO_NUM_CLASSES_20'
file_Variant_All = 'npy/nn_a1rho_Variant-All_Unweighted_False_NO_NUM_CLASSES_20'
...
plt.title('Class index: = 1, 20 (scalar), =10 (pseudoscalar)')
