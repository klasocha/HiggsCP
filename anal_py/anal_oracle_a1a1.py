...
directory = '../../HiggsCP_data/a1a1/'
w_00 = np.load(os.path.join(directory, 'a1a1_raw.w_00.npy'))
w_10 = np.load(os.path.join(directory, 'a1a1_raw.w_10.npy'))
w_20 = np.load(os.path.join(directory, 'a1a1_raw.w_20.npy'))

w_02 = np.load(os.path.join(directory, 'a1a1_raw.w_02.npy'))
w_04 = np.load(os.path.join(directory, 'a1a1_raw.w_04.npy'))
w_06 = np.load(os.path.join(directory, 'a1a1_raw.w_06.npy'))
w_08 = np.load(os.path.join(directory, 'a1a1_raw.w_08.npy'))
w_12 = np.load(os.path.join(directory, 'a1a1_raw.w_12.npy'))
w_14 = np.load(os.path.join(directory, 'a1a1_raw.w_14.npy'))
w_16 = np.load(os.path.join(directory, 'a1a1_raw.w_16.npy'))
w_18 = np.load(os.path.join(directory, 'a1a1_raw.w_18.npy'))
...
plt.plot(x,roc_auc_calc,'v', label='Calculated')
