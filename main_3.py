...
# import train_rhorho, train_a1rho, train_a1a1, train_boostedtrees, train_svm, train_randomforest, train_rhorhoZ
import train_rhorho_3,train_rhorhoZ_3
...
types = {"nn_rhorho": train_rhorho_3.start}
...
parser.add_argument("-f", "--features", dest="FEAT", help="Features",
	choices= ["Variant-All", "Variant-1.0", "Variant-1.1", "Variant-2.0", "Variant-2.1", "Variant-2.2", "Variant-3.0", "Variant-3.1", "Variant-3.2", "Variant-4.0", "Variant-4.1"])
