...
$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_rhorho -i $RHORHO_DATA -e 50 -f Variant-3.1 -d 0.2 --beta $BETA --pol_b $B --pol_c $C -l 6 -s 300
