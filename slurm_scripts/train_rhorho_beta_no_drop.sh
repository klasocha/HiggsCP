#!/bin/bash -l
## Job name
#SBATCH -J TrainBetaRHORHONoDrop
## Number of nodes
#SBATCH -N 1
...
echo "TrainBeta rhorho NODROP Job. Beta: " $BETA

$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_rhorho -i $RHORHO_DATA -e 50 -f Variant-3.1 -d 0 --beta $BETA -l 6 -s 300
