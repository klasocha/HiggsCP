#!/bin/bash -l
## Job name
#SBATCH -J TrainA1A1ExpnormSmearNoDrop
## Number of nodes
#SBATCH -N 1
...
echo "TrainSmear a1a1 NODROP Job. Beta: " $BETA
echo "Sigma: " $SIGMA

$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1a1 -i $A1A1_DATA -e 50 -f Variant-3.2 -d 0 --beta $BETA --smear_scale $SIGMA -l 6 -s 300
