...
echo "TrainFeaturesA1A1 Job. Dropout 0.0. Method: " $FEATURE_SET
$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1a1 -i $A1A1_DATA -e 50 -f $FEATURE_SET -d 0 -l 6 -s 300
