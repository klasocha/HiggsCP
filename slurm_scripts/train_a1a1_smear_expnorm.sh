#!/bin/bash -l
## Job name
#SBATCH -J TrainA1A1ExpnormSmear
## Number of nodes
#SBATCH -N 1
...
$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1a1 -i $A1A1_DATA -e 50 -f Variant-3.2 -d 0.2 --beta $BETA --smear_scale $SIGMA -l 6 -s 300
