...
echo "TrainBeta a1rho Job. Beta: " $BETA

$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1rho -i $A1RHO_DATA -e 50 -f Variant-3.1 -d 0.2 --beta $BETA -l 6 -s 300
