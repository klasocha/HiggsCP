#!/bin/bash -l
## Job name
#SBATCH -J TrainRhoRhoExpnormSmearNoDrop
## Number of nodes
#SBATCH -N 1
...
echo "TrainSmear rhorho Job. NODROP Beta: " $BETA
echo "Sigma: " $SIGMA

$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_rhorho -i $RHORHO_DATA -e 50 -f Variant-3.2 -d 0 --beta $BETA --smear_scale $SIGMA -l 6 -s 300
