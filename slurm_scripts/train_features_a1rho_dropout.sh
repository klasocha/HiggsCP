#!/bin/bash -l
## Job name
#SBATCH -J TrainFeaturesA1RhoDropout
## Number of nodes
#SBATCH -N 1
...
echo "TrainFeaturesA1Rho Job. Dropout 0.2. Method: " $FEATURE_SET
$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1rho -i $A1RHO_DATA -e 50 -f $FEATURE_SET -d 0.2 -l 6 -s 300
