...
echo "TrainBeta a1a1 NODROP Job. Beta: " $BETA

$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_a1a1 -i $A1A1_DATA -e 50 -f Variant-3.1 -d 0  --beta $BETA -l 6 -s 300
