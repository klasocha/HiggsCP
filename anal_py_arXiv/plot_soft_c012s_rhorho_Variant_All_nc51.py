...
for i in range(data_len):
    calc_c012s[i][0] = calc_c0s[i] * (2./51.)
    calc_c012s[i][1] = calc_c1s[i] * (2./51.) -1.0
    calc_c012s[i][2] = calc_c2s[i] * (2./51.) -1.0

    preds_c012s[i][0] = preds_c0s[i] * (2./51.)
    preds_c012s[i][1] = preds_c1s[i] * (2./51.) -1.0
    preds_c012s[i][2] = preds_c2s[i] * (2./51.) -1.0
...
i = 1
filename = "soft_c012s_calc_preds_rhorho_Variant-All_nc_51_event_1"
