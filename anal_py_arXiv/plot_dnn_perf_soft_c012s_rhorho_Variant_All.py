...
plt.plot(x,train_losses_c0, 'o', color = 'black', label='Training c0')
plt.plot(x,train_losses_c1, 'd', color = 'black', label='Training c1')
plt.plot(x,train_losses_c2, 'x', color = 'black', label='Training c2')
plt.legend()
plt.ylim([0.0, 3.0])
