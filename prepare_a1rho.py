...
if __name__ == "__main__":
    ...
    np.save(os.path.join(data_path, "a1rho_raw.w_00.npy"), weights_00)
    np.save(os.path.join(data_path, "a1rho_raw.w_02.npy"), weights_02)
    np.save(os.path.join(data_path, "a1rho_raw.w_04.npy"), weights_04)
    np.save(os.path.join(data_path, "a1rho_raw.w_06.npy"), weights_06)
    np.save(os.path.join(data_path, "a1rho_raw.w_08.npy"), weights_08)
    np.save(os.path.join(data_path, "a1rho_raw.w_10.npy"), weights_10)
    np.save(os.path.join(data_path, "a1rho_raw.w_12.npy"), weights_12)
    np.save(os.path.join(data_path, "a1rho_raw.w_14.npy"), weights_14)
    np.save(os.path.join(data_path, "a1rho_raw.w_16.npy"), weights_16)
    np.save(os.path.join(data_path, "a1rho_raw.w_18.npy"), weights_18)
    np.save(os.path.join(data_path, "a1rho_raw.w_20.npy"), weights_20)
