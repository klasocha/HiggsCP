...
def read_raw_all(kind, args):
    ...
    if kind == "Higgs":
        ...
        for letter in ["a", "b"][:args.ZDATASETS]:
...
if __name__ == "__main__":
    ...
    np.save(os.path.join(data_path, "rhorho_Higgs_Z115_raw.data.npy"), data)
    np.save(os.path.join(data_path, "rhorho_Higgs_Z115_raw.w_a.npy"), weights_a)
    np.save(os.path.join(data_path, "rhorho_Higgs_Z115_raw.w_b.npy"), weights_b)
    np.save(os.path.join(data_path, "rhorho_Higgs_Z115_raw.perm.npy"), perm)
