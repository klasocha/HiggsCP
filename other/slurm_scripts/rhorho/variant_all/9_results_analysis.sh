...
#SBATCH --job-name=variant_all_results_analysis
#SBATCH --nodes=1
...
# Plots (soft_c012s)
python main.py  --action "plot" --input "results/soft_c012s/variant_all/51_classes_c" \
--output "plots/figures" --option "RESULTS_ANALYSIS_2" --num_classes "51" \
--training_method "soft_c012s" --features Variant-All --dataset "test" \
--use_filtered_data
python main.py --action "plot" --input "results/soft_c012s/variant_all/51_classes_c" \
--output "plots/figures" --option "RESULTS_ANALYSIS_2" --num_classes "51" \
--training_method "soft_c012s" --features Variant-All --dataset "valid" \
--use_filtered_data
python main.py --action "plot" --input "results/soft_c012s/variant_all/51_classes_c" \
--output "plots/figures" --option "RESULTS_ANALYSIS_2" --num_classes "51" \
--training_method "soft_c012s" --features Variant-All --dataset "train" \
--use_filtered_data
...
# Plots (soft_argmaxs)
python main.py --action "plot" --input "results/soft_argmaxs/51_classes_variant_all/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-All \
...
python main.py --action "plot" --input "results/soft_argmaxs/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_3" --features Variant-All \
...
# Plots (regr_weights)
python main.py --action "plot" --input "results/regr_weights/51_classes_variant_all/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_1" --num_classes "51" \
--training_method "regr_weights" --features Variant-All --dataset "test" --use_filtered_data
python main.py --action "plot" --input "results/regr_weights/51_classes_variant_all/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_1" --num_classes "51" \
--training_method "regr_weights" --features Variant-All --dataset "train" --use_filtered_data
python main.py --action "plot" --input "results/regr_weights/51_classes_variant_all/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_1" --num_classes "51" \
--training_method "regr_weights" --features Variant-All --dataset "valid" --use_filtered_data
...
python main.py --action "plot" --input "results/regr_weights/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_1" --num_classes "51" \
--training_method "regr_weights" --features Variant-All --dataset "train"
python main.py --action "plot" --input "results/regr_weights/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_1" --num_classes "51" \
--training_method "regr_weights" --features Variant-All --dataset "valid"


# Plots (regr_c012s)
python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "test" --use_filtered_data
python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "train" --use_filtered_data
python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "valid" --use_filtered_data

python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "test"
python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "train"
python main.py --action "plot" --input "results/regr_c012s/51_classes_variant_all/predictions" \
--output "plots/figures" --option "RESULTS_ANALYSIS_4" --num_classes "51" \
--training_method "regr_c012s" --features Variant-All --dataset "valid"
