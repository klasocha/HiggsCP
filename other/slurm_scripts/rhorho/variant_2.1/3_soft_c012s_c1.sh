...
#SBATCH --job-name=variant_2.1_soft_c012s_c1
#SBATCH --nodes=1
...
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c1" \
--hits_c012s "hits_c1s" --features Variant-2.1

# Prediction (test)
python main.py --action "predict_test" --input "data" --num_classes "51" \
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c1" \
--features Variant-2.1 --hits_c012s "hits_c1s" --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "51" \
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c1" \
--features Variant-2.1 --hits_c012s "hits_c1s"
