...
#SBATCH --job-name=variant_2.1_soft_weights
#SBATCH --nodes=1
...
--model_location "51_classes_variant_2.1" --features Variant-2.1 --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "51" \
--model_location "51_classes_variant_2.1" --features Variant-2.1
