...
#SBATCH --job-name=variant_1.0_soft_c012s_c1
#SBATCH --nodes=1
...
--training_method "soft_c012s" --model_location "variant_1.0/21_classes_c1" \
--hits_c012s "hits_c1s" --features Variant-1.0
python main.py --action "train" --input "data" --num_classes "51" --epochs $EPOCHS \
--training_method "soft_c012s" --model_location "variant_1.0/51_classes_c1" \
--hits_c012s "hits_c1s" --features Variant-1.0

# Prediction (test)
python main.py --action "predict_test" --input "data" --num_classes "21" \
--training_method "soft_c012s" --model_location "variant_1.0/21_classes_c1" \
--features Variant-1.0 --hits_c012s "hits_c1s" --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "21" \
--training_method "soft_c012s" --model_location "variant_1.0/21_classes_c1" \
--features Variant-1.0 --hits_c012s "hits_c1s"
