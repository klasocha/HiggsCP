...
#SBATCH --job-name=variant_1.0_regr_argmaxs
#SBATCH --nodes=1
...
--training_method "regr_argmaxs" --model_location "21_classes_variant_1.0" \
...
--training_method "regr_argmaxs" --model_location "21_classes_variant_1.0" \
--features Variant-1.0 --use_filtered_data --keras "v2"
...
# Plots (21 classes)
python main.py --action "plot" --input "results/regr_argmaxs/21_classes_variant_1.0/predictions" \
