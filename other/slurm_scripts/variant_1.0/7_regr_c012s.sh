...
#SBATCH --job-name=variant_1.0_regr_c012s
#SBATCH --nodes=1
...
--training_method "regr_c012s" --model_location "21_classes_variant_1.0" \
...
# Plots (21 classes)
python main.py --action "plot" --input "results/regr_c012s/21_classes_variant_1.0/predictions" \
