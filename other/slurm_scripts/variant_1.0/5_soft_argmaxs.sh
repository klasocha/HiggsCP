...
#SBATCH --job-name=variant_1.0_soft_argmaxs
#SBATCH --nodes=1
...
--training_method "soft_argmaxs" --model_location "21_classes_variant_1.0" \
...
# Plots (21 classes)
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_1.0/predictions" \
