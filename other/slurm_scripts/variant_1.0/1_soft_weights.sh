...
#SBATCH --job-name=variant_1.0_soft_weights
#SBATCH --nodes=1
...
--training_method "soft_weights" --model_location "21_classes_variant_1.0" \
...
--model_location "21_classes_variant_1.0" --features Variant-1.0 --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "51" \
--model_location "51_classes_variant_1.0" --features Variant-1.0 --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "21" \
--model_location "21_classes_variant_1.0" --features Variant-1.0
python main.py --action "predict_test" --input "data" --num_classes "51" \
--model_location "51_classes_variant_1.0" --features Variant-1.0
...
# Plots (21 classes)
python main.py --action "plot" --input "results/soft_weights/21_classes_variant_1.0/predictions" \
