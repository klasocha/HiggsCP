...
#SBATCH --job-name=variant_1.0_soft_c012s_c0
#SBATCH --nodes=1
...
--training_method "soft_c012s" --model_location "variant_1.0/21_classes_c0" \
--hits_c012s "hits_c0s" --features Variant-1.0
python main.py --action "train" --input "data" --num_classes "51" --epochs $EPOCHS \
--training_method "soft_c012s" --model_location "variant_1.0/51_classes_c0" \
--hits_c012s "hits_c0s" --features Variant-1.0
