...
--training_method "soft_argmaxs" --model_location "21_classes_variant_all" \
...
# Plots (21 classes)
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_all/predictions" \
