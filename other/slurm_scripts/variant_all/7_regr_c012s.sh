...
--training_method "regr_c012s" --model_location "21_classes_variant_all" \
...
# Plots (21 classes)
python main.py --action "plot" --input "results/regr_c012s/21_classes_variant_all/predictions" \
