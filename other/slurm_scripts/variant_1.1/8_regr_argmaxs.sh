...
#SBATCH --job-name=variant_1.1_regr_argmaxs
#SBATCH --nodes=1
...
--training_method "regr_argmaxs" --model_location "21_classes_variant_1.1" \
...
--training_method "regr_argmaxs" --model_location "21_classes_variant_1.1" \
--features Variant-1.1 --use_filtered_data --keras "v2"
...
# Plots (21 classes)
python main.py --action "plot" --input "results/regr_argmaxs/21_classes_variant_1.1/predictions" \
