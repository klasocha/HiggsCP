...
--training_method "soft_weights" --model_location "21_classes_variant_1.1" 
...
--model_location "21_classes_variant_1.1" --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "51" \
--model_location "51_classes_variant_1.1" --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "21" \
--model_location "21_classes_variant_1.1"
python main.py --action "predict_test" --input "data" --num_classes "51" \
--model_location "51_classes_variant_1.1"
...
# Plots (21 classes)
python main.py --action "plot" --input "results/soft_weights/21_classes_variant_1.1/predictions" \
