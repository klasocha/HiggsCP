...
--training_method "soft_c012s" --model_location "variant_1.1/21_classes_c0" \
--hits_c012s "hits_c0s" --features Variant-1.1
python main.py --action "train" --input "data" --num_classes "51" --epochs $EPOCHS \
--training_method "soft_c012s" --model_location "variant_1.1/51_classes_c0" \
--hits_c012s "hits_c0s" --features Variant-1.1
