...
sbatch --dependency afterok:$JOBID0 -p plgrid other/slurm_scripts/variant_1.1/1_soft_weights.sh
...
sbatch --dependency afterok:$JOBID4 -p plgrid other/slurm_scripts/variant_all/1_soft_weights.sh
