...
#SBATCH --job-name=variant_4.1_soft_argmaxs
#SBATCH --nodes=1
...
--training_method "soft_argmaxs" --model_location "21_classes_variant_4.1" \
...
# Plots (21 classes)
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "test" --num_classes "21" --use_filtered_data
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "valid" --num_classes "21" --use_filtered_data
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "train" --num_classes "21" --use_filtered_data

python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "test" --num_classes "21"
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "valid" --num_classes "21"
python main.py --action "plot" --input "results/soft_argmaxs/21_classes_variant_4.1/predictions" \
--output "plots/figures" --format "png" --option "RESULTS_ANALYSIS_3" --features Variant-4.1 \
--training_method "soft_argmaxs" --dataset "train" --num_classes "21"
