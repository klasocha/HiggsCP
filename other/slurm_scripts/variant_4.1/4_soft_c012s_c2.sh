...
#SBATCH --job-name=variant_4.1_soft_c012s_c2
#SBATCH --nodes=1
...
--training_method "soft_c012s" --model_location "variant_4.1/21_classes_c2" \
--hits_c012s "hits_c2s" --features Variant-4.1
python main.py --action "train" --input "data" --num_classes "51" --epochs $EPOCHS \
--training_method "soft_c012s" --model_location "variant_4.1/51_classes_c2" \
--hits_c012s "hits_c2s" --features Variant-4.1

# Prediction (test)
python main.py --action "predict_test" --input "data" --num_classes "21" \
--training_method "soft_c012s" --model_location "variant_4.1/21_classes_c2" \
--features Variant-4.1 --hits_c012s "hits_c2s" --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "21" \
--training_method "soft_c012s" --model_location "variant_4.1/21_classes_c2" \
--features Variant-4.1 --hits_c012s "hits_c2s"
...
# Plots (21 classes)
python main.py  --action "plot" --input "results/soft_c012s/variant_4.1/21_classes_c" \
