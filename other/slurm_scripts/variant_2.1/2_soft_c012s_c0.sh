...
#SBATCH --job-name=variant_2.1_soft_c012s_c0
#SBATCH --nodes=1
...
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c0" \
--hits_c012s "hits_c0s" --features Variant-2.1

# Prediction (test)
python main.py --action "predict_test" --input "data" --num_classes "51" \
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c0" \
--features Variant-2.1 --use_filtered_data
python main.py --action "predict_test" --input "data" --num_classes "51" \
--training_method "soft_c012s" --model_location "variant_2.1/51_classes_c0" \
