...
pathIN  = "../laptop_results/nn_rhorho_Variant-All_soft_argmaxs_Unweighted_False_NO_NUM_CLASSES_51/monit_npy/"
pathOUT = "figures/"

calc_hits_argmaxs  = np.load(pathIN+'test_soft_calc_hits_argmaxs.npy')
preds_hits_argmaxs  = np.load(pathIN+'test_soft_preds_hits_argmaxs.npy')
...
plt.hist(calc_argmaxs, histtype='step', bins=51,  color = 'black')
plt.hist(preds_argmaxs, histtype='step', bins=51,  color = 'red')
plt.xlim([0, 50])
