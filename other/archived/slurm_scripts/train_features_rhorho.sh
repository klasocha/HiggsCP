...
echo "TrainFeaturesRhoRho Job. Dropout 0. Method: " $FEATURE_SET
$ANACONDA_PYTHON_PATH/python2.7 $WORKDIR/main.py -t nn_rhorho -i $RHORHO_DATA -e 250 -f $FEATURE_SET -d 0 -l 6 -s 300
