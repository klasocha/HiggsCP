...
popts = np.load('../../HiggsCP_data/a1rho/popts.npy')
pcovs = np.load('../../HiggsCP_data/a1rho/pcovs.npy')

weights = np.load('../../HiggsCP_data/a1rho/a1rho_raw.w.npy')
